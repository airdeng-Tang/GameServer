...
namespace GameServer.Managers
{
    class ChatManager : Singleton<ChatManager>
    {
        ...
        public Dictionary<int, List<ChatMessage>> Local = new Dictionary<int, List<ChatMessage>>();//本地 key代表地图Id
        public Dictionary<int, List<ChatMessage>> Team = new Dictionary<int, List<ChatMessage>>();//队伍 key代表队伍Id
        public Dictionary<int, List<ChatMessage>> Guild = new Dictionary<int, List<ChatMessage>>();//公会 key代表公会Id
