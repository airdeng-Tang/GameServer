...
namespace GameServer.Managers
{
    class FriendManager
    {
        ...
        bool friendChanged = false;//好友列表是否变化

        public FriendManager(Character ower)
        {
            this.Owner = ower;
            this.InitFriends();
            this.AskFriends();
        ...
        public bool get()
        {
            return this.friendChanged;
        }

        public void PostProcess(NetMessageResponse message,bool b)
        {
            if (friendChanged)
            {
